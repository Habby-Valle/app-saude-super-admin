...
import type { PatientsGrowthData } from "@/app/(main)/(clinic-admin)/admin/reports/actions"

interface ClinicPatientsGrowthReportProps {
  data: PatientsGrowthData[]
  loading: boolean
  onExport: () => void
}

export function ClinicPatientsGrowthReport({
  data,
  loading,
  onExport,
}: ClinicPatientsGrowthReportProps) {
