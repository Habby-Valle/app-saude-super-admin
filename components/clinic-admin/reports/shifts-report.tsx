...
import type { ShiftsReportData } from "@/app/(main)/(clinic-admin)/admin/reports/actions"

interface ClinicShiftsReportProps {
  data: ShiftsReportData[]
  loading: boolean
  onExport: () => void
}

export function ClinicShiftsReport({ data, loading, onExport }: ClinicShiftsReportProps) {
